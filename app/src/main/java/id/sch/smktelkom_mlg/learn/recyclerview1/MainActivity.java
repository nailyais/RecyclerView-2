...
public class MainActivity extends AppCompatActivity {
    ...
    private void fillData() {
        ...
        String[] arJudul = rescources.getStringArray(R.array.places);
        String[] arDeskripsi = rescources.getStringArray(R.array.place_desc);
        TypedArray a = rescources.obtainTypedArray(R.array.places_picture);
